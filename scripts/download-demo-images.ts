...
const IMAGE_SPECS: ImageSpec[] = [
	{
		...
		description:
			"A golden retriever sitting in tall grass. Complex fur boundaries make this a great SAM showcase.",
	...
	},
	{
		...
		description:
			"Close-up portrait of a cat. Whiskers and fur boundaries challenge precise segmentation.",
	...
	},
	{
		...
		description:
			"Portrait of a person with curly hair. Hair segmentation is the #1 real-world use case.",
	...
	},
	{
		...
		description:
			"A bicycle leaning against a textured wall. Thin spokes test fine structure segmentation.",
	...
	},
	{
		...
		name: "Coral Reef",
		description:
			"Vibrant coral reef teeming with life. Organic complexity and dense overlapping structures.",
	...
	},
	{
		...
		name: "Flower Bouquet",
		description:
			"A lush flower bouquet with overlapping petals. Tests segmentation of overlapping organic shapes.",
	...
	},
	{
		...
		description:
			"An ornate building facade with intricate architectural details and filigree.",
	...
	},
	{
		...
		description:
			"An overhead shot of a food platter with many items. Clean boundaries and many distinct objects.",
	...
	},
	{
		...
		description:
			"A person in a crowd, partially occluded by others. Tests occlusion handling.",
	...
	},
	{
		...
		name: "Motorcycle",
		description:
			"A motorcycle with chrome details and complex shapes. Reflective surfaces challenge segmentation.",
	...
	},
	{
		...
		description:
			"Looking up through a tree canopy with leaves against sky. Complex organic branching patterns.",
	...
	},
	{
		...
		description:
			"Jewelry displayed on a stand with chains and gems. Fine detail and reflective surfaces.",
	...
	},
	{
		...
		name: "Bowl of Salad",
		description:
			"A bowl of salad with mixed textures and overlapping ingredients.",
	...
	},
	{
		...
		description:
			"A cat sitting on or near a keyboard. Multiple subjects with different textures.",
	...
	},
	{
		...
		description:
			"A soccer player captured mid-kick. Motion blur adds segmentation difficulty.",
	...
	},
	{
		...
		description:
			"A potted succulent plant in close-up. Clean subject with interesting geometric texture.",
...
async function downloadAndProcess(
	...
	try {
		...
		console.log(
			`    saved (${(buffer.byteLength / 1024 / 1024).toFixed(1)} MB)`,
		);
	} catch (err) {
